...
<tr>
<th>BOOK CALL No.</th><th>BOOK NAME</th><th>AUTHOR</th><th>PUBLISHER</th><th>QUANTITY</th><th>ISSUED</th><th>ADDED DATE</th>
</tr>
<% 
...
%>
<tr>
<td><%=rs.getString("callno") %></td><td><%=rs.getString("name") %></td><td><%=rs.getString("author") %></td><td><%=rs.getString("publisher") %></td><td><%=rs.getInt("quantity") %></td><td><%=rs.getInt("issued") %></td><td><%=rs.getDate("added_date") %></td>
</tr>
<%
	}
