        		...
        		<div class="col-lg-12">
        			<section class="panel">
            			...
            			<div class="panel-body">
								...
								<form action="ActivateStudent" method="get" class="form-horizontal bucket-form">
									<div class="form-group">
                   	 				...
                   	 				<div class="form-group">
                        				<label class="col-sm-3 control-label">Enter Contact</label>
                       						<div class="col-sm-6">
        								...
        								<div class="col-lg-offset-2 col-lg-10" style="padding-left:70px;">
          									<buton type="submit" class="btn btn-info">Activate</buton>
										</div>
									</div>
								</form>
							</div>
