        		...
        		<div class="col-lg-12">
        			<section class="panel">
            			...
            			<div class="panel-body">
								...
								<form action="IssueBook" method="get" class="form-horizontal bucket-form">
 									<div class="form-group">
                        				<label class="col-sm-3 control-label">Book Call No.</label>
                       						<div class="col-sm-6">
                            					<input type="text" class="form-control" name="book_cn">
                        					</div>
                   	 				</div>
  									<div class="form-group">
                    				...
                    				<div class="form-group">
                       					<label class="col-sm-3 control-label">Student Contact</label>
                       						<div class="col-sm-6">
									...
									<div class="form-group">
        								<div class="col-lg-offset-2 col-lg-10" style="padding-left:70px;">
          									<buton type="submit" class="btn btn-info">Issue Book</buton>
										</div>
									</div>
								</form>
							</div>
